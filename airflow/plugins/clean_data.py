...
def transform():
    ...
    CRAWL_FOLDER = '/mnt/d/Programming/Vietnamese-Text-Generator/data/test/raw'
    vnexpress = []
...
def dump(raw_news, processed_news):
    ...
    """
    raw_news.to_csv('/mnt/d/Programming/Vietnamese-Text-Generator/data/test/csv/vnexpress.csv')
    
    PROCESSED_FOLDER = '/mnt/d/Programming/Vietnamese-Text-Generator/data/test/processed'
